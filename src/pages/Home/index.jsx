      ...
      <div className='container' id='landingPage'>
        ...
        <section className='section1 styleimage'>
          <div className='content'>
            ...
            <p className='subheading'>
              Ensuring the safety and protection of every student, where their
        ...
        <section className='section2'>
          <div className='content'>
            ...
            <div className='row'>
              <div className='column'>
                ...
                <p>
                  ...
                  keeping them informed about their childs well-being.
                </p>
            ...
            <button className='cta-button' onClick={redirect} style={{ backgroundColor: '#007BFF', color: 'white' }}>
              Register Now
            </button>

            <button className='cta-button' onClick={rediretLogin} style={{ backgroundColor: '#28A745', color: 'white' }}>
              Login
            </button>
          </div>
        </section>
